                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-6 col-md-3">
                                <div class="health-metric bg-purple-light text-center">
                                    ...
                                    <p class="h4 fw-bold text-purple mb-0">
            ...
            <div class="col-lg-4">
                ...
                <div class="card border-0 shadow-lg mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="quick-stat-item">
                            ...
                            <span class="fw-semibold">{{ $totalKonseling }} sesi</span>
                        </div>
                        <div class="quick-stat-item">
                            <span class="small text-muted">Konseling Terakhir</span>
                            <span class="fw-semibold">{{ $konselingTerakhir }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-lg mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <!-- Edit Profile (Breeze punya halaman edit profil termasuk ubah password) -->
                            <a href="{{ route('profile.edit') }}" class="btn btn-outline-warning text-start">
                ...
                <div class="card border-0 shadow-lg emergency-card">
                    ...
                    <div class="card-body" style="background-color: #fef2f2;">
                        ...
                        <button class="btn btn-danger w-100 btn-sm" data-bs-toggle="modal"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        Apakah Anda yakin ingin menghubungi <b>Bidan Koordinator</b> sekarang?
                                    </div>
                                    <div class="modal-footer">
                                        <a href="tel:08123456789" class="btn btn-danger">Ya, Hubungi</a>
